                                                    ...
                                                    <div class="row m-l-0 m-r-0">
                                                        <div class="col-sm-4 bg-c-lite-green user-profile">
                                                            <div class="card-block text-center text-white">
                                                                ...
                                                                <h6 class="f-w-600">{{ $customer->title}}. {{ $customer->fname}} {{ $customer->lname}}</h6>
                                                            ...
                                                            <div class="card-block">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <h6 class="text-muted f-w-400">{{ $customer->addressline}}</h6>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <p class="m-b-10 f-w-600">Zipcode</p>
                                                                        <h6 class="text-muted f-w-400">{{ $customer->zipcode}}</h6>
                                                                    </div>
                                                                </div>
