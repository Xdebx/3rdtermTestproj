...
<h1>Date of consultation: {{$created_at}}</h1>
<h2>Observation/Comment: {{ $observation }}</h2>
<h3>Amount of checkup: {{$consult_cost}}</h3>
<img src="{{ $message->embed(public_path('/images/clinicpet.jpg')) }}" style="padding:0px; margin:0px" />
</body>
</html> --}}
                        ...
                        <tbody>
                          <tr>
                            <td align="center" valign="middle" class="mobile-centered-container" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;">
                              <h1 class="header-heading mobile-centered-item" style="color:#fff;font-size:24px;letter-spacing:-.43px;line-height:30px;margin:0;padding:0 0 20px;">Date of consultation: {{$created_at}}</h1>
                              <div>
                                <p class="header-text mobile-centered-item" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#fff;font-size:11px;line-height:14px;margin:0;padding-bottom:0;">
                                  ...
                                  <span style="padding: 0 11px 0 10px">|</span>Welcome to Pet Clinic 
                                  </p>
                                </div>
                              </td>
                            </tr>
                          ...
                          <tbody>
                            <tr>
                              <td align="center" valign="top" class="section-heading" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;padding-bottom:15px;">
                                <h5 style="color:#9B9B9B;font-size:11px;margin:0;padding:0;text-transform:uppercase;">Information</h5>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" valign="top" class="content-item" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;padding-bottom:25px;">
                                <h1 style="color:#4A4A4A;font-size:24px;letter-spacing:-.7px;line-height:29px;margin:0;padding:0;">
                                  <span class="highlighted-text" style="color: #000">Pet Identification: {{$pet_id}}</span>
                                </h1>
                              </td>
                            </tr>
                            <tr>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td align="left" valign="top" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;">
                                        <img src="{{ $message->embed(public_path('/images/clinicpet.jpg')) }}" alt="verification changes" class="is-fittogrid" style="-ms-interpolation-mode: bicubic; border: 0; display: block; max-width: 100%; outline: none; text-decoration: none; width: auto">
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                            ...
                            <tr>
                              <td align="left" valign="top" class="content-item" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;padding-bottom:25px;">
                                <p style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;margin:0;"><strong>Observation/Comment:</strong> {{ $observation }}.</p>
                              </td>
                            </tr>
                            <tr>
                                <td align="left" valign="top" class="content-item" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;padding-bottom:25px;">
                                  <h1 style="color:#4A4A4A;font-size:24px;letter-spacing:-.7px;line-height:29px;margin:0;padding:0;">
                                    <span class="highlighted-text" style="color: #000"><strong> Amount of checkup: ${{$consult_cost}}</strong></span>
                                  </h1>
                                </td>
                              </tr>
                          </tbody>
